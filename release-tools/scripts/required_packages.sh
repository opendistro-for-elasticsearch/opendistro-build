...
then
  sudo wget -nv https://github.com/mikefarah/yq/releases/download/v4.2.1/yq_${PLATFORM}_amd64 -O /usr/bin/yq && sudo chmod +x /usr/bin/yq
elif [ "$ARCH" = "x86" ] || [ "$ARCH" = "i386" ]
then
  sudo wget -nv https://github.com/mikefarah/yq/releases/download/v4.2.1/yq_${PLATFORM}_386 -O /usr/bin/yq && sudo chmod +x /usr/bin/yq
else
  sudo wget -nv https://github.com/mikefarah/yq/releases/download/v4.2.1/yq_${PLATFORM}_${ARCH} -O /usr/bin/yq && sudo chmod +x /usr/bin/yq
fi
