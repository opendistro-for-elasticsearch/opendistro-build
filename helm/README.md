...
### Notes Enabling Service Topologies
This feature was added in Kubernetes 1.17 and is still in Alpha phase as of 1.20. In order to use it the required feature gates must be enabled in the cluster. More info here
...
| `global.services.topologyKeys`                            | Default topology keys to use in service, unless specified individually                                                                                   | `[]`                                                                    |
...
| `elasticsearch.master.service.topologyKeys`               | Topology keys for elasticsearch master service                                                                                                            | fallback to `global.services.topologyKey`                               |
...
| `elasticsearch.client.service.topologyKeys`               | Topology keys for elasticsearch client service                                                                                                            | fallback to `global.services.topologyKey`                               |
...
| `elasticsearch.data.service.topologyKeys`                 | Topology keys for elasticsearch data servce                                                                                                              | fallback to `global.services.topologyKey`                               |
