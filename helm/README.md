...
| `elasticsearch.master.livenessProbe`                      | Configuration for the [livenessProbe](https://kubernetes.io/docs/tasks/configure-pod-container/configure-liveness-readiness-probes/)                     | `{"initialDelaySeconds":60,"tcpSocket":{"port":"transport"},"periodSeconds":10}`                                                                    |
...
| `elasticsearch.client.livenessProbe`                      | Configuration for the [livenessProbe](https://kubernetes.io/docs/tasks/configure-pod-container/configure-liveness-readiness-probes/)                     | `{"initialDelaySeconds":60,"tcpSocket":{"port":"transport"},"periodSeconds":10}`                                                                    |
...
| `elasticsearch.data.livenessProbe`                        | Configuration for the [livenessProbe](https://kubernetes.io/docs/tasks/configure-pod-container/configure-liveness-readiness-probes/)                     | `{"initialDelaySeconds":60,"tcpSocket":{"port":"transport"},"periodSeconds":10}`                                                                    |
