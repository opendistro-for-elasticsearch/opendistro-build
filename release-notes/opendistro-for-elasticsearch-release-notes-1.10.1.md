...
* Re-design and re-implmement a Security Kibana Plugin based on the new Kibana API, which enables streamline workflows, improve usability, and audit logging.
