...
* The Alerting feature supports setting [email destination](https://github.com/opendistro-for-elasticsearch/alerting/pull/244) that allows sending notifications without using a web hook. 
