...
PLUGINS="opendistro-security/opendistro_security_kibana_plugin-$OPENDISTRO_VERSION.1.zip opendistro-alerting/opendistro-alerting-$OPENDISTRO_VERSION.0.zip"
