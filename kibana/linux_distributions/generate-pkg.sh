...
PLUGINS="opendistro-security/opendistro_security_kibana_plugin-$OPENDISTRO_VERSION.0.zip opendistro-alerting/opendistro-alerting-$OPENDISTRO_VERSION.0.zip opendistro-index-management/opendistro_index_management_kibana-$OPENDISTRO_VERSION.1.zip"
